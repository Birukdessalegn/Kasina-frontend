      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-2.5 lg:grid-cols-4">
        <div className="rounded-xl border border-slate-200 bg-white p-2.5 sm:p-3 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="text-[10px] sm:text-[11px] font-semibold uppercase text-slate-400">Total Recipes</span>
            <div className="rounded-lg bg-amber-50 p-1.5 text-amber-600">
              <Utensils className="h-3.5 w-3.5" />
            </div>
          </div>
          <p className="mt-1 text-base sm:text-lg font-black text-slate-900">{metrics.total}</p>
          <p className="text-[10px] text-slate-500 mt-0.5">Configured menu dishes</p>
        </div>

        <div className="rounded-xl border border-slate-200 bg-white p-2.5 sm:p-3 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="text-[10px] sm:text-[11px] font-semibold uppercase text-slate-400">Avg Food Cost</span>
            <div className="rounded-lg bg-blue-50 p-1.5 text-blue-600">
              <Percent className="h-3.5 w-3.5" />
            </div>
          </div>
          <p className="mt-1 text-base sm:text-lg font-black text-blue-600">{metrics.avgFoodCost}%</p>
          <p className="text-[10px] text-slate-500 mt-0.5">Target: 28% - 35%</p>
        </div>

        <div className="rounded-xl border border-slate-200 bg-white p-2.5 sm:p-3 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="text-[10px] sm:text-[11px] font-semibold uppercase text-slate-400">High Margin</span>
            <div className="rounded-lg bg-emerald-50 p-1.5 text-emerald-600">
              <TrendingUp className="h-3.5 w-3.5" />
            </div>
          </div>
          <p className="mt-1 text-base sm:text-lg font-black text-emerald-600">{metrics.profitableCount}</p>
          <p className="text-[10px] text-slate-500 mt-0.5">Cost &lt; 32%</p>
        </div>

        <div className="rounded-xl border border-slate-200 bg-white p-2.5 sm:p-3 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="text-[10px] sm:text-[11px] font-semibold uppercase text-slate-400">Cost Warnings</span>
            <div className="rounded-lg bg-rose-50 p-1.5 text-rose-600">
              <AlertCircle className="h-3.5 w-3.5" />
            </div>
          </div>
          <p className="mt-1 text-base sm:text-lg font-black text-rose-600">{metrics.highCostCount}</p>
          <p className="text-[10px] text-slate-500 mt-0.5">Cost &gt; 40%</p>
        </div>
      </div>
