    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-6 text-center">
          <div className="mx-auto flex h-28 w-28 items-center justify-center overflow-hidden rounded-2xl bg-[#0a1128] shadow-lg ring-1 ring-slate-900/10">
            <img
              src="/kasina-hotel-logo.png"
              alt="Kasina Hotel Logo"
          ...
          <p className="mt-1 text-sm text-slate-500">
            Hotel & Suites Management System
          </p>
        </div>
