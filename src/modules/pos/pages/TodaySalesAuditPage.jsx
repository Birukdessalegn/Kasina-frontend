      ...
      <div id="sales-audit-report-printable" className="space-y-6">
        ...
        <div className="mb-6 border-b-2 border-slate-900 pb-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="header-title text-2xl font-black uppercase text-slate-900">KASINA HOTEL & SUITES</h1>
        ...
        <div className="mt-10 pt-4 border-t-2 border-slate-900">
          <div className="flex justify-between items-center text-xs font-bold text-slate-900">
            <div>
              <p className="font-extrabold uppercase">KASINA HOTEL — DAILY SALES AUDIT REPORT</p>
